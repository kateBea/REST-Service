...
@Composable
fun PasswordField(isError: Boolean = false, onNewValue: (String) -> Unit = { }) {
    ...
    OutlinedTextField(
        ...
        maxLines = 1,
        label = { InputFieldLabel(valor = "Contraseña") },
...
@Composable
fun InputField(label: String, isError: Boolean = false, onNewValue: (String) -> Unit = { }) {
    ...
    OutlinedTextField(
        ...
        maxLines = 1,
        label = { InputFieldLabel(valor = label) },
        textStyle = TextStyle(fontSize = 20.sp),
        isError = isError,
    )
...
@Composable
fun InputFieldLabel(valor: String) {
    Text(
        text = valor,
        style = TextStyle(
...
@Composable
fun Toggle(label: String, onCheckedChange: (Boolean) -> Unit = {}) {
