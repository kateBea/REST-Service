...
fun PantallaPizzaPago(navController: NavController, usuarioVM: UsuarioVM) {
    Scaffold(
        ...
        Column (
            ...
            BodyText(value = "Detalles de compra")
            Divider(
                modifier = Modifier
                    .fillMaxWidth(0.7f)
            ...
            Column (
                ...
                for (ingrediente in usuarioVM.usuariosState.ingredientesElegidos) {
                    ...
                    Row (
                        ...
                        BodyText("${ingrediente.nombreIngrediente}: ")
                        BodyText("€${ingrediente.precioIngrediente}")
                    }
                }
                ...
                Row (
                    ...
                    BodyText("Masa (${usuarioVM.usuariosState.tipoMasa}): ")
                    BodyText("€${usuarioVM.usuariosState.precioMasa}")
                }
            }
            ...
            Spacer(modifier = Modifier.size(10.dp))
            BodyText(value = "Detalles de cliente")
            Divider(
                modifier = Modifier
                    .fillMaxWidth(0.7f)
                    .padding(top = 10.dp, bottom = 10.dp),
            ...
            Column (
                ...
                Row (
                    ...
                    BodyText("Nombre: ")
                    BodyText("${usuarioVM.usuariosState.usuarioActual?.username}")
                }
                ...
                Row (
                    ...
                    BodyText("Email: ")
                    BodyText(value = "${usuarioVM.usuariosState.usuarioActual?.email}")
                }
                ...
                Row (
                    ...
                    BodyText("Teléfono: ")
                    BodyText(value = "${usuarioVM.usuariosState.usuarioActual?.phoneNumber}")
                }
            }
